...
score: 8.6
cover: ../../assets/g-the-blood-of-dawnwalker.jpg
hero: ../../assets/h-the-blood-of-dawnwalker.jpg
platforms:
  - { name: PC, best: true }
  - { name: PS5 }
  - { name: "Xbox Series" }
...
facts:
  en:
    ...
    - { label: Director, value: "Konrad Tomaszkiewicz, of The Witcher 3" }
    - { label: Engine, value: "Unreal Engine 5" }
    - { label: Structure, value: "30 in-game days and nights, 8 segments each" }
    - { label: Length, value: "50 to 70 hours" }
  fr:
    - { label: Édité par, value: "Bandai Namco Entertainment" }
    - { label: Réalisateur, value: "Konrad Tomaszkiewicz, de The Witcher 3" }

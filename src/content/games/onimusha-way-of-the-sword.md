...
score: 8.2
cover: ../../assets/g-onimusha-way-of-the-sword.jpg
hero: ../../assets/h-onimusha-way-of-the-sword.jpg
platforms:
  - { name: "Switch 2", best: true }
  - { name: PS5 }
  - { name: "Xbox Series" }
  - { name: PC }
genre:
...
facts:
  en:
    ...
    - { label: First mainline entry since, value: "Dawn of Dreams, 2006" }
    - { label: Protagonist, value: "Miyamoto Musashi, modelled on Toshiro Mifune" }
    - { label: Setting, value: "Edo-era Kyoto, twisted by Malice" }
    - { label: Length, value: "About 20 hours, largely linear" }
  fr:
    - { label: Moteur, value: "RE Engine" }
    - { label: Premier épisode principal depuis, value: "Dawn of Dreams, 2006" }
